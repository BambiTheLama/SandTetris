...
/// <summary>
/// Klasa odpowiedzialna za animację piasku w menu.
/// </summary>
public class MenuSandAnimation : MonoBehaviour
{
    /// <summary>
    /// Wysokość siatki komórek piasku.
    /// </summary>
    private static readonly int gridHeight = 173;

    /// <summary>
    /// Szerokość siatki komórek piasku.
    /// </summary>
    ...
    /// <summary>
    /// Stosunek rozmiaru komórki do odstępu między nimi.
    /// </summary>
    ...
    /// <summary>
    /// Sprawdź, czy dana komórka jest wolna.
    /// </summary>
    /// <param name="x">Współrzędna x komórki.</param>
    /// <param name="y">Współrzędna y komórki.</param>
    /// <returns>Zwraca true, jeśli komórka jest pusta, w przeciwnym razie false.</returns>
