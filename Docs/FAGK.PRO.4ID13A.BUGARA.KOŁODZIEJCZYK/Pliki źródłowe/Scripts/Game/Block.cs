...
public class Block
{
    ...
    /// <summary>
    /// Realizuje ruch bloku w dół z uwzględnieniem prędkości.
    /// </summary>
    ...
    /// <summary>
    /// Sprawdza, czy blok ma komórkę na podanej pozycji.
    /// </summary>
    /// <param name="x">Współrzędna X komórki.</param>
    /// <param name="y">Współrzędna Y komórki.</param>
    /// <returns>Prawda, jeśli blok ma komórkę na danej pozycji, w przeciwnym razie fałsz.</returns>
